...
#define OMV_ENABLE_SENSOR_MDMA  (0)
...
#define OMV_MAIN_MEMORY         RAM_D1       // data, bss and heap memory
#define OMV_STACK_MEMORY        ITCM        // stack memory
//#define OMV_DMA_MEMORY          SRAM2       // DMA buffers memory.
#define OMV_DMA_MEMORY          RAM_D1       // DMA buffers memory.
//#define OMV_FB_MEMORY           AXI_SRAM    // Framebuffer, fb_alloc
#define OMV_FB_MEMORY           RAM_D1    // Framebuffer, fb_alloc
//#define OMV_JPEG_MEMORY         SRAM3       // JPEG buffer memory.
//#define OMV_VOSPI_MEMORY        SRAM4       // VoSPI buffer memory.

//#define OMV_FB_SIZE             (400K)      // FB memory: header + VGA/GS image
#define OMV_FB_SIZE             (200K)
