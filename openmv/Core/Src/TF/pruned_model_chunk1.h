...
#ifndef TENSORFLOW_LITE_PRUNED_MODEL_CHUNK1_H_
#define TENSORFLOW_LITE_PRUNED_MODEL_CHUNK1_H_
...
extern const unsigned char pruned_model_chunk1[];
extern const int pruned_model_chunk1_len;
