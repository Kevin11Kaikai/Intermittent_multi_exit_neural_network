...
#ifndef TENSORFLOW_LITE_UTIL_CONV_MODEL_DATA_H_
#define TENSORFLOW_LITE_UTIL_CONV_MODEL_DATA_H_

extern const unsigned char conv_model[];
extern const int conv_model_len;

#endif  // TENSORFLOW_LITE_UTIL_LINEAR_MODEL_DATA_H_
