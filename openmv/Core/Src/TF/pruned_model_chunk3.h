...
#ifndef TENSORFLOW_LITE_PRUNED_MODEL_CHUNK3_H_
#define TENSORFLOW_LITE_PRUNED_MODEL_CHUNK3_H_
...
extern const unsigned char pruned_model_chunk3[];
extern const int pruned_model_chunk3_len;
